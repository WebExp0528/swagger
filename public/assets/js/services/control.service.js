app.service('ControlService', function ($rootScope, APIHandler, Utils) {
    ...
    this.GetTsByDept = function () {
    	return APIHandler.Get('crtls/testPlans/statusByDept');
    };
    
    this.GetTsByRegion = function () {
    	return APIHandler.Get('crtls/testPlans/statusByRegion');
    };
    
    this.GetTrByDept = function () {
    	return APIHandler.Get('crtls/testResults/statusByDept');
    };
    
    this.GetTrByRegion = function () {
    	return APIHandler.Get('crtls/testResults/statusByRegion');
    };
    ...
    this.ImportControls = function(idd, fileModel) {
    	if(fileModel == null || fileModel.length < 1){
            return APIHandler.NullPromise();
        }
        ...
        var url = 'crtls/' + idd + '/importControls';
        return APIHandler.UploadFile(url, formdata);
    };
});
