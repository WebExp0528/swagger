...
app.service('VendorService', ['APIHandler', '$localStorage', function (APIHandler, $localStorage) {
    ...
    this.DeleteVendor = function (id) {
        return APIHandler.Delete('vendor/' + id);
    };
    this.PostVendor = function(params){
        return APIHandler.Post('vendor', params);
    };
    this.PutVendor = function(id, params){
        return APIHandler.Put('vendor/'+id, params);
    };
    ...
    this.calcMetrics = function (asId, vrName) {
    	var params = {};
        return APIHandler.Post('vendorriskassessment/computeRiskDataMetrics/' + vrName + '/' + asId, params);
    };
