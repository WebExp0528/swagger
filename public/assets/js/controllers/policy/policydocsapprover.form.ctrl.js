(function () {
    ...
    app.controller('PolicyDocsApproverCtrl', PolicyApproverController);
    ...
    function PolicyApproverController($scope, $rootScope, $state, $stateParams, PolicyService, Utils) {
        ...
        $scope.submitAction = function(){
            ...
            $scope.VM.key = idd;
            PolicyService.AddPolicyDocsApprover($scope.VM, $stateParams.id).then(function (res) {
            }).finally(function () {
                $state.go('app.polproc.policydocs.update', {id: $stateParams.id});
            });
        };
