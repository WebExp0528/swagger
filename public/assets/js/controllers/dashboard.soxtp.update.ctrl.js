(function () {
    ...
    DashSOXTestPlanUpdateController.$inject = ['$scope', '$rootScope', '$state', '$stateParams', 'ComplianceService', 'Utils'];
    app.controller('DashSOXTPUpdateCtrl', DashSOXTestPlanUpdateController);


    function DashSOXTestPlanUpdateController($scope, $rootScope, $state, $stateParams, ComplianceService, Utils) {
    	$scope.mainTitle = $state.current.title;
        $scope.mainDesc = "Update SOX Test Plan";
