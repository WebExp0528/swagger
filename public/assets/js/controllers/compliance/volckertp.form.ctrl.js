(function () {
    ...
    VOLCKERTestPlanFormController.$inject = ['$scope', '$rootScope', '$state', 'ComplianceService', 'Utils'];
    app.controller('VOLCKERTPFormCtrl', VOLCKERTestPlanFormController);


    function VOLCKERTestPlanFormController($scope, $rootScope, $state, ComplianceService, Utils) {

        $scope.mainTitle = $state.current.title || 'loading';
        $scope.mainDesc = "Add Volcker Assessment";
        ...
        $scope.submitAction = function () {
            ...
            ComplianceService.FileUpload(idd, fileModel).then(function(res){
                ...
                ComplianceService.PostVOLCKERTPAssessment($scope.VM).then(function (res) {
                    console.log('res',res);
                }).finally(function () {
