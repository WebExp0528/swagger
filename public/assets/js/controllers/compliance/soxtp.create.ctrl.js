(function () {
    ...
    SOXTPCreateController.$inject = ['$scope', '$rootScope', '$state', 'ComplianceService', 'Utils'];
    app.controller('SOXTPCreateCtrl', SOXTPCreateController);


    function SOXTPCreateController($scope, $rootScope, $state, ComplianceService, Utils) {

        $scope.mainTitle = $state.current.title || 'loading';
        $scope.mainDesc = "Create a SOX Test Plan";
