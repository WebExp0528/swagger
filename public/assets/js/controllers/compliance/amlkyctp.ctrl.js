(function () {
    ...
    AMLKYCTestPlanController.$inject = ['$scope', '$rootScope', '$state', '$filter', '$uibModal', 'ComplianceService', 'ChartFactory', 'Utils'];
    app.controller('AMLKYCTPCtrl', AMLKYCTestPlanController);

    function AMLKYCTestPlanController($scope, $rootScope, $state, $filter, $uibModal, ComplianceService, ChartFactory, Utils) {
        $scope.mainTitle = $state.current.title;
        $scope.mainDesc = "Add Edit Search & Delete AML/KYC Assessments";
        ...
        $scope.downloadTemp2 = function () {
            ...
            var data = {};
            data.sheetName = "AML/KYC Test Plan";
            data.body = [];

            data.body.push({
                col: 3,
                row: 2,
                text: 'AML/KYC Test Plan Assessments',
        ...
        $scope.deleteAction = function (r) {
            ...
            confirmation.result.then(function () {
                ...
                ComplianceService.DeleteAMLKYCTPAssessment(r.id).then(function (data) {
        ...
        function loadContents() {
            ComplianceService.GetAMLKYCTPStatus().then(function (data) {
                ChartFactory.CreatePieChart('By Status', 'By Status', data, 'rcsaStatus');
                return ComplianceService.GetAMLKYCTPPeriod();
            }).then(function (data) {
                ChartFactory.CreateMultiColChart('By period', data, 'periodChart');
                return ComplianceService.GetAMLKYCTPDept();
            }).then(function (data) {
        ...
        function loadAssessments() {
            ComplianceService.GetAMLKYCTPAssessments().then(function (data) {
