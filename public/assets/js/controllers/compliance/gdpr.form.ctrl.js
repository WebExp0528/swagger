(function () {
	GDPRAssessmentFormController.inject = ['$scope', '$rootScope', '$state', 'RiskService', 'Utils', '$filter'];
    app.controller('GDPRAssessmentFormCtrl', GDPRAssessmentFormController);
    function GDPRAssessmentFormController($scope, $rootScope, $state, RiskService, Utils, $filter) {
        $scope.mainTitle = $state.current.title;
        $scope.mainDesc = "Add GDPR Assessment";
        ...
        $scope.submitAction = function () {
            ...
            RiskService.FileUpload(idd, fileModel).then(function (res) {
                ...
                RiskService.AddGDPRAssessment($scope.VM).then(function (res) {
                    console.log('res', res);
                }).finally(function () {
