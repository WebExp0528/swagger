(function () {
    ...
    SOCTestPlanFormController.$inject = ['$scope', '$rootScope', '$state', 'ComplianceService', 'Utils'];
    app.controller('SOCTPFormCtrl', SOCTestPlanFormController);


    function SOCTestPlanFormController($scope, $rootScope, $state, ComplianceService, Utils) {

        $scope.mainTitle = $state.current.title || 'loading';
        $scope.mainDesc = "Add SOC Assessment";
