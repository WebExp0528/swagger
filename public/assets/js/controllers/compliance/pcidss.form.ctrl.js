(function () {
    ...
    PCIDSSFormController.$inject = ['$scope', '$rootScope', '$state', 'ComplianceService', 'Utils'];
    app.controller('PCIDSSFormCtrl', PCIDSSFormController);


    function PCIDSSFormController($scope, $rootScope, $state, ComplianceService, Utils) {
