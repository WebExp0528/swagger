(function () {
    ...
    VOLCKERTPCreateController.$inject = ['$scope', '$rootScope', '$state', 'ComplianceService', 'Utils'];
    app.controller('VOLCKERTPCreateCtrl', VOLCKERTPCreateController);


    function VOLCKERTPCreateController($scope, $rootScope, $state, ComplianceService, Utils) {

        $scope.mainTitle = $state.current.title || 'loading';
        $scope.mainDesc = "Create a Volcker Assessment";
        ...
        $scope.submitAction = function () {
        	$state.go('app.compliance.volckertp.create_assessment',{assessName: $scope.VM.assessName, assessDate: $scope.VM.assessmentsDate, assessmentBy: $scope.VM.assessmentBy, assessType: "Volcker", page: 'create'});
        };

        $scope.cancelAction = function () {
            if ($scope.Form.VolckerTpAssess.$dirty) {
