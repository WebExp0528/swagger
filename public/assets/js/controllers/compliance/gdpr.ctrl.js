(function () {
    ...
    GDPRAssessmentCtrl.$inject = ['$scope', '$rootScope', '$state', '$filter', '$uibModal', 'RiskService', 'OPRiskService', 'ChartFactory', 'Utils'];
    app.controller('GDPRAssessmentCtrl', GDPRAssessmentCtrl);

    function GDPRAssessmentCtrl($scope, $rootScope, $state, $filter, $uibModal, RiskService, OPRiskService, ChartFactory, Utils) {
        $scope.mainTitle = $state.current.title;
        $scope.mainDesc = "Add Edit Search & Delete GDPR Assessments";
        ...
        RiskService.GetGDPRStatus()
            ...
            .then(function (data) {
                ...
                return RiskService.GetGDPRDept();
            })
            .then(function (data) {
                ChartFactory.CreatePieChart('By Department', 'Department', data, 'deptstacked');
                loadAssessments();
            });
        ...
        function loadAssessments() {
            RiskService.GetGDPRAssessment().then(function (data) {
