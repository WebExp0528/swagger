(function () {
    ...
    AMLKYCTestPlanFormController.$inject = ['$scope', '$rootScope', '$state', 'ComplianceService', 'Utils'];
    app.controller('AMLKYCTPFormCtrl', AMLKYCTestPlanFormController);


    function AMLKYCTestPlanFormController($scope, $rootScope, $state, ComplianceService, Utils) {
