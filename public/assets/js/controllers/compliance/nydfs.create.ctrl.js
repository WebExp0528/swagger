(function () {
    'use strict';
    NYDFSAssessmentCreateController.$inject = ['$scope', '$rootScope', '$state', 'RiskService', 'Utils', '$filter', 'UniqueID'];
    app.controller('NYDFSAssessmentCreateCtrl', NYDFSAssessmentCreateController);
    function NYDFSAssessmentCreateController($scope, $rootScope, $state, RiskService, Utils, $filter, UniqueID) {
        ...
        $scope.goBack = function () {
            $state.go('app.compliance.nydfs.update', {id: $rootScope.asId});
        };
