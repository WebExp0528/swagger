(function () {
    ...
    DashSOXRCMUpdateController.$inject = ['$scope', '$rootScope', '$state', '$stateParams', 'ComplianceService', 'Utils'];
    app.controller('DashSOXRCMUpdateCtrl', DashSOXRCMUpdateController);


    function DashSOXRCMUpdateController($scope, $rootScope, $state, $stateParams, ComplianceService, Utils) {
        $scope.mainTitle = $state.current.title;
        $scope.mainDesc = "Update SOX Risk Control Matrix";
