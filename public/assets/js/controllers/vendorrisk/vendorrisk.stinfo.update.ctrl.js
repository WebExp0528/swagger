(function () {
    ...
    function VendorStinfoUpdateController($scope, $rootScope, $state, VendorService, Utils, $filter, $location, UniqueID) {
        ...
        $scope.mainDesc = "Update Vendor Risk Assessment";
        ...
        VendorService.GetRiskType().then(function (risktype) {
            ...
            var d1 = moment(data.approvedDate);
            var d2 = moment(data.assessmentsDate);
            data.approvedDate = (d1.isValid()) ? d1.format(dtype) : '';
            data.assessmentsDate = (d2.isValid()) ? d2.format(dtype) : '';
            data.approvedDtStr = data.approvedDate;
            data.assessmentDtStr = data.assessmentsDate;
        ...
        function completeAssessment(vendor){
            vendor.statusMsg = "Completed Submission";
            if(vendor.vendorId == null || vendor.vendorId == '')
                vendor.vendorId = $scope.generateId();
