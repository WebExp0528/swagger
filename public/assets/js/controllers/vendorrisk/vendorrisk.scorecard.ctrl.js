...
(function(){
    ...
    function ScoreController ($scope, $rootScope, $state, RiskDataService, ChartFactory, Utils, VendorService, $filter){
        ...
        function setupVRiskChart(data){
            ...
            ChartFactory.BuildHeatMap2('riskHeatMap', ChartOpts);
        }
        ...
        function setupMultiVendChart(data){
            ...
            ChartFactory.BuildHeatMap2('multiVendHeatMap', ChartOpts);
        }
        ...
        function setupVendorChart(vend){
            ...
            if(angular.isArray($scope.VendList[vend]) && $scope.VendList[vend].length > 0) {
                ...
                ChartFactory.BuildHeatMap2('vendorHeatMap', ChartOpts);
            }
        }
