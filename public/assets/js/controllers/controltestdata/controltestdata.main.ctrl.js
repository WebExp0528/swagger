(function () {
    ...
    ControlTestDataMainCtrl.$inject = ['$scope', '$rootScope', '$state', '$filter', '$uibModal', 'ControlTestDataService', 'Utils'];
    app.controller('ControlTestDataMainCtrl', ControlTestDataMainCtrl);

    function ControlTestDataMainCtrl($scope, $rootScope, $state, $filter, $uibModal, ControlTestDataService, Utils) {
        var vm = this;
