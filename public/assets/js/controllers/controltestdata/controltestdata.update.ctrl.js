(function () {
    ControlTestDataUpdateController.$inject = ['$scope', '$rootScope', '$state', '$stateParams', '$uibModal', '$filter', 'ControlTestDataService', 'Utils'];
    app.controller('ControlTestDataUpdateCtrl', ControlTestDataUpdateController);

    function ControlTestDataUpdateController($scope, $rootScope, $state, $stateParams, $uibModal, $filter, ControlTestDataService, Utils) {
        var vm = this;
        ...
        vm.submitAction = function(){
          ...
          ControlTestDataService.Put(controlTestDataId, vm.formdata).then(function (res) {
