...
(function () {
    'use strict';
    AssessmentGenCreateController.$inject = ['$rootScope', '$state', 'AssessmentService', 'Utils', '$filter', 'UniqueID'];
    app.controller('AssessmentGenCreateCtrl', AssessmentGenCreateController);
    function AssessmentGenCreateController($rootScope, $state, AssessmentService, Utils, $filter, UniqueID) {
        var vm = this;
    	...
    	data.assessmentsDate = $state.params.assessmentsDate;
        ...
        vm.goBack = function () {
            $state.go('app.admin.assessment.main');
        };

        vm.downloadExcel = function () {
            var data = {};
            data.heights = [];
            data.sheetName = "Assessment";
            data.body = [];
            ...
            AssessmentService.DownloadExcel(data).then(function (response) {
