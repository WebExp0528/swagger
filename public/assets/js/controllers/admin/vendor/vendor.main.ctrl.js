(function () {
    ...
    VendorMainCtrl.$inject = ['$scope', '$rootScope', '$state', '$filter', '$uibModal', 'VendorService', 'Utils'];
    app.controller('VendorMainCtrl', VendorMainCtrl);

    function VendorMainCtrl($scope, $rootScope, $state, $filter, $uibModal, VendorService, Utils) {
        var vm = this;
        vm.mainTitle = $state.current.title;
        vm.mainDesc = "Vendor Management";
        ...
        vm.deleteAction = function (r) {
            ...
            confirmation.result.then(function () {
                ...
                var rowId = r.id;
                VendorService.DeleteVendor(rowId).then(function (data) {
                    if (data.status === 200){
                        vm.Grid1.Total--;
