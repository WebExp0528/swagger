...
(function () {
  ...
  app.controller(
    'ConfirmDialogueCtrl',
    function ($scope, $rootScope, $uibModalInstance, items) {
  ...
  app.controller(
    'SelectListCtrl',
    function ($scope, $rootScope, $filter, $uibModalInstance, items, Utils) {
      $rootScope.app.CurrentModal = $uibModalInstance;
  ...
  /* -------------------------------------------------------------------------- */
  /*                        Single Select List Controller                       */
  /* -------------------------------------------------------------------------- */
  app.controller(
    'SingleSelectListCtrl',
    function ($scope, $rootScope, $filter, $uibModalInstance, items, Utils) {
      $rootScope.app.CurrentModal = $uibModalInstance;
