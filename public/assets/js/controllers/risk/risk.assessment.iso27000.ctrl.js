(function () {
    RiskISO27000AssessmentController.inject = ['$scope', '$rootScope', '$state', 'RiskService', 'Utils', '$filter', 'UniqueID'];
    app.controller('RiskISO27000AssessmentCtrl', RiskISO27000AssessmentController);
    function RiskISO27000AssessmentController($scope, $rootScope, $state, RiskService, Utils, $filter, UniqueID) {
        $scope.mainTitle = $state.current.title;
        $scope.mainDesc = "ISO 27000 Assessment Generator";
            ...
            $scope.addControls = function () {
                ...
                RiskService.GetControlData().then(function (data) {
                	var iso27k = data.filter(function (el) {
                		return el.controlSource === 'ISO27k';
                	});
