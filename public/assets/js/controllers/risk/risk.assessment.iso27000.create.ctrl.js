(function () {
    'use strict';
    RiskISO27000AssessmentCreateController.$inject = ['$rootScope', '$state', 'RiskService', 'Utils', '$filter', 'UniqueID'];
    app.controller('RiskISO27000AssessmentCreateCtrl', RiskISO27000AssessmentCreateController);
    function RiskISO27000AssessmentCreateController($rootScope, $state, RiskService, Utils, $filter, UniqueID) {
    	var vm = this;
        ...
        vm.downloadExcel = function () {
            var data = {};
            data.heights = [];
            data.sheetName = "ISO 27000 Assessment";
            data.body = [];
