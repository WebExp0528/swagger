(function () {
    RiskNYDFSAssessmentController.inject = ['$scope', '$rootScope', '$state', 'RiskService', 'Utils', '$filter', 'UniqueID'];
    app.controller('RiskNYDFSAssessmentCtrl', RiskNYDFSAssessmentController);
    function RiskNYDFSAssessmentController($scope, $rootScope, $state, RiskService, Utils, $filter, UniqueID) {
        $scope.mainTitle = $state.current.title;
        $scope.mainDesc = "NYDFS Assessment Generator";
