(function () {
    'use strict';
    RiskNYDFSAssessmentCreateController.$inject = ['$rootScope', '$state', 'RiskService', 'Utils', '$filter', 'UniqueID'];
    app.controller('RiskNYDFSAssessmentCreateCtrl', RiskNYDFSAssessmentCreateController);
    function RiskNYDFSAssessmentCreateController($rootScope, $state, RiskService, Utils, $filter, UniqueID) {
        var vm = this;
        ...
        vm.goBack = function () {
            $state.go('app.risk.assessment.nydfs.main');
        };

        vm.downloadExcel = function () {
            var data = {};
            data.heights = [];
            data.sheetName = "NYDFS Assessment";
            data.body = [];
