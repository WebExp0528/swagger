(function () {
    'use strict';
    RiskGDPRAssessmentCreateController.$inject = ['$rootScope', '$state', 'RiskService', 'Utils', '$filter', 'UniqueID'];
    app.controller('RiskGDPRAssessmentCreateCtrl', RiskGDPRAssessmentCreateController);
    function RiskGDPRAssessmentCreateController($rootScope, $state, RiskService, Utils, $filter, UniqueID) {
        var vm = this;
