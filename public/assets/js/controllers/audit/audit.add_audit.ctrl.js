(function () {
    AuditADController.$inject = ['$scope', '$rootScope', '$state', '$uibModal', '$filter', 'AuditService', 'Utils', 'RiskService'];
    app.controller('AuditAdd_AuditCtrl', AuditADController);

    function AuditADController($scope, $rootScope, $state, $uibModal, $filter, AuditService, Utils, RiskService) {
        var vm = this;
            ...
            AuditService.FileUpload(idd, fileModel).then(function(res){
                ...
                AuditService.AddAudits(vm.formdata).then(function (res) {
                    ...
                    if (vm.enableTopicConfirmation) {
                        ...
                        $rootScope.app.Mask = false;
                        var confirmation = Utils.CreateConfirmModal("Confirm New Topic", "Are you sure you want to create new topic", "Yes", "No");
